...
//
//    List<int>::iterator myitr = classToTest.begin();
//    cout << "first object: " << *myitr << endl;
//
//    myitr++;
//    myitr++;
//    myitr++;
...
//
//
//    myitr = classToTest.insert(myitr, 5);
//
//    myitr = classToTest.begin();
//
//
//    for (int i = 0; i < classToTest.size(); i++) {
//        cout << "object: " << *myitr << endl;
//        myitr++;
//
//    }
//
